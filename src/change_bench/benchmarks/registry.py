...
BENCHMARK_PAIRS: dict[str, Callable[..., list[BenchmarkCase]]] = {
    ...
    "pelt_mv_gaussian": pair_pelt_mv_gaussian,
    ...
    "moving_window_mv_gaussian": pair_moving_window_mv_gaussian,
    "moving_window_rank": pair_moving_window_rank,
    "binseg": pair_binseg,
    "binseg_mv_gaussian": pair_binseg_mv_gaussian,
}
...
MULTIVARIATE_ONLY_PAIRS: set[str] = {
    "moving_window_rank",
    "moving_window_mv_gaussian",
    "pelt_rank",
    "pelt_mv_gaussian",
    "binseg_mv_gaussian",
}
